...
SG Wave Terminal can automatically detect and set the base directory from your terminal's working directory. When you `cd` into a project directory, SG Wave uses OSC 7 escape sequences to learn this location.
