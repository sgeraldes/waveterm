...
Wave ships with 4 default widgets in the widgets bar (terminal, files, web, and sysinfo). You can modify or remove these by overriding their config in widgets.json. The names of the 4 widgets, in order, are:
