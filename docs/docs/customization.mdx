...
It is also possible to create your own themes using custom colors, gradients, images and more by editing your presets.json config file. To see how SG Wave's built in tab themes are defined, you can check out our [default presets file](https://github.com/sgeraldes/waveterm/blob/main/pkg/wconfig/defaultconfig/presets.json).
...
in the [default termthemes.json file](https://github.com/sgeraldes/waveterm/blob/main/pkg/wconfig/defaultconfig/termthemes.json).
...
You can set the key `tab:preset` in your [SG Wave config file](/config) to apply a theme to all new tabs.
...
SG Wave supports powerful custom backgrounds for your tabs using images, patterns, gradients, and colors. The quickest way to set an image background is using the `wsh setbg` command:
