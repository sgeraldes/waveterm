...
Wave AI is in active beta with included AI credits while we refine the experience. Share feedback and file issues on the [SG Wave repository](https://github.com/sgeraldes/waveterm).
