...
Here's the set of default keybindings available in SG Wave. It is split into sections.
...
SG Wave allows setting a custom global hotkey to focus your most recent window from anywhere on your computer. For more information on this, see [the config docs](./config#customizable-systemwide-global-hotkey).
