...
SG Wave Terminal is a modern terminal fork that includes graphical capabilities like web browsing, file previews, and AI assistance alongside traditional terminal features. This guide will help you get started.
...
You can also download installers directly from the [fork releases page](https://github.com/sgeraldes/waveterm/releases).
...
- **Blocks**: The building blocks of SG Wave. Each block can be a terminal, web browser, file preview, or other widget.
...
1. **Terminal Features**
   ...
   - Includes the `wsh` command for interacting with SG Wave's GUI features
...
1. **Open Your First New Tab**
   ...
   - New SG Wave tabs start with a single terminal block
...
- Configure [SG Wave AI](./waveai) to use your preferred AI models
- Check out [Configuration](./config) for detailed customization options

## Getting Help

- Report issues on the fork: [github.com/sgeraldes/waveterm/issues](https://github.com/sgeraldes/waveterm/issues)
- Browse releases and changes: [github.com/sgeraldes/waveterm/releases](https://github.com/sgeraldes/waveterm/releases)
