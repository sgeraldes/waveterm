        ...
        <div className="flex items-center gap-0.5 mt-2">
            <button
                ...
                className={cn(
                    ...
                    thumbsUpClicked ? "text-accent" : "text-secondary hover:bg-hover hover:text-primary"
                )}
                title="Good Response"
            >
            ...
            <button
                ...
                className={cn(
                    "p-1.5 rounded cursor-pointer transition-colors",
                    thumbsDownClicked ? "text-accent" : "text-secondary hover:bg-hover hover:text-primary"
                )}
                title="Bad Response"
            >
            ...
            {messageText?.trim() && (
                <button
                    ...
                    className={cn(
                        "p-1.5 rounded cursor-pointer transition-colors",
                        copied ? "text-success" : "text-secondary hover:bg-hover hover:text-primary"
                    )}
                    title="Copy Message"
                >
